      ...
      <div class="row justify-content-center">
        <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
            <img src="foto evan.jpg" class="card-img-top" alt="Anggota" style="height: 300px; object-fit: cover;">
            <div class="card-body">
              <h5 class="card-title">Muhamad Evan Yuwawira Nugraha</h5>
              ...
              <div class="d-flex justify-content-center btn-container">
                <a href="https://github.com/evanyn17-mhs" class="btn btn-timbul">GitHub</a>
                <a href="https://wa.me/6281213833072" class="btn btn-wa">Kontak WhatsApp</a>
              </div>
            </div>
          </div>
        </div>
